...
describe('Form components', () => {
    it('renders form field and labels correctly', () => {
      ...
      expect(screen.getByTestId('email-input')).toHaveAttribute('data-slot', 'form-control');
      expect(screen.getByText('Enter your email')).toHaveAttribute('data-slot', 'form-description');
    });
